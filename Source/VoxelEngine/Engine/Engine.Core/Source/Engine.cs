...
public sealed class Engine
{
    ...
    private readonly EnginePackagesManager _enginePackagesManager;
    ...
    private void Init()
    {
        ...
        var packages = game.GetPackages();
        _enginePackagesManager.Add(packages);

        _engineSubSystemsManager.OnInitialize();
        _enginePackagesManager.OnInitialize();
        game.OnInit();
    }
    ...
    private void Run()
    {
        ...
        game.StartGame();
        _enginePackagesManager.OnGameStarted();
        heartbeat.SetTargetFrameRate(engineSettings.Window_FPS);
